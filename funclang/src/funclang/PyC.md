...
5. **Logical Expressions**:
    - Logical operators `and` (`&&`) and `or` (`||`) are supported:
        ...
        ```pyc
        if (x > 5 && y < 10) { print("Both conditions are true") }
        ```
...
5. **Printing a new line**:
	...
	**Output**:
	...
	1. **Syntax Errors**:
		- Detected during parsing when the code does not conform to the EBNF grammar.
		- Example:
		  ```pyc
		  x = 5 +
	...
	**Output**:
	...
	#### 11. Possible Boolean expressions